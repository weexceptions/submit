...
#frame2{
 border: 1px solid black; margin-right: 1px; float:bottom; margin-top: 0px
}
body{
...
<nav class="navbar navbar-inverse navbar-static-top">
    ...
    <!--/.container-fluid -->
            ...
            <IFRAME seamless="seamless" scrolling="yes" src="adminhome.jsp" id="frame1" name="ContentFrame" width="80%" height="800" >
                <IFRAME seamless="seamless" scrolling="yes" id="frame2" name="Content2Frame" width="79%"  height="500" />
            </IFRAME>
            </div>
